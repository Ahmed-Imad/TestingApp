...
namespace TestingApp 
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // coloring the text and entering first and last names >>>
            ...
            Console.WriteLine();
            Console.WriteLine($"WELCOME MR. {firstName.ToUpper()} {lastName.ToUpper()}.");
            ...
            // COLORING THE TEXT AND ASKING ANOTHER QUESTION USING SWITCH
